...
clf=DecisionTreeClassifier(max_depth=15,criterion='entropy',min_samples_leaf=20)
...
pd.concat([ID_Test,pred],axis=1).to_csv(r"C:/Users/ishan/Documents/MS/ASU/508 Data Mining 1/Assignment 1/TestResult1.csv", index = None)
res=pd.read_csv('C:/Users/ishan/Documents/MS/ASU/508 Data Mining 1/Assignment 1/TestResult1.csv')
res.head()
